          ...
          <div className="w-[100%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                Expertise includes detailed technical drawings, dynamic websites, strategic SEO, 
                and efficient construction management, ensuring high-quality results across diverse projects.
                </p>
              </div>
